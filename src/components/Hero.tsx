...
//   return (
//     <section className="h-[90vh] flex items-center justify-center bg-gradient-to-b from-background to-muted">
//       <motion.div 
...
//           Hi, I'm <span className="text-primary">Arjun Singh Gurjar</span>
//         </h1>
//         <p className="text-xl md:text-2xl text-muted-foreground mb-8">
//           Full Stack Developer | Next.js Expert | TypeScript Enthusiast
//         </p>
